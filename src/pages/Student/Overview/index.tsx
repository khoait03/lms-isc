...
const Overview = () => {
  ...
  const data = [
    { name: "Tổng số môn đã hoàn thành", value: 7, color: "#3498db" },
            ...
            <div className="flex">
              ...
              <div className="flex-1 mt-[65px] mr-6">
                <div className="flex justify-between border-b-4  border-b-[#823B00] py-1">
                  <span>Tổng số môn: </span><span className="text-[#373839] font-bold">10</span>
                </div>
                <div className="flex justify-between border-b-4  border-b-[#823B00] py-1">
                  <span>Số môn đã hoàn thành: </span><span className="text-[#2EACEE] font-bold">7</span>
                </div>
                <div className="flex justify-between border-b-4  border-b-[#823B00] py-1">
                  <span>Số môn chưa hoàn thành: </span> <span className="text-[#FF7506] font-bold">3</span>
                </div>
              </div>
            </div>
                  ...
                  <tbody className="rounded-xl">
                    {students.map((student, index) => (
                      <tr key={student.id} style={{ borderRadius: '20px' }} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-100'}>
                        ...
                        <td className={`px-4 py-4 text-base text-center font-source-sans w-2/12 ${student.status === 'completed' ? 'text-[#49C510]' : 'text-[#ED2025]'} `}>
