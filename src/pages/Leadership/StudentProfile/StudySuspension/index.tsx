...
interface Student {
  id: string;
  name: string;
  dateOfBirth: string; // Ngày sinh có thể để dạng string (dd/MM/yyyy)
            ...
            <thead className="bg-orange-500 text-white">
              <tr>
                {[
                  ...
                  { key: 'suspensionClass', label: 'Lớp bảo lưu' },
                  { key: 'suspensionDate', label: 'Ngày bảo lưu' },
