        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div className="relative bg-white rounded-xl shadow-lg w-full max-w-3xl md:max-w-2xl lg:max-w-[900px] pt-6 pb-6 px-4 md:pt-6 md:pb-8 md:px-14">
                ...
                <div className="flex justify-between">
                    ...
                    {/* Cột phải, căn phải mà không làm hẹp nội dung */}
                ...
                <div className="border border-orange-400 rounded-lg p-6 bg-orange-50  mt-6 mb-12">
                    <div className="space-y-3">
                        <div className="mb-3 flex">
                            ...
                            <p className="w-4/5 overflow-hidden text-ellipsis whitespace-nowrap">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                        </div>
                        <div className="mb-3 flex">
                            <p className="font-bold w-1/5 text-start whitespace-nowrap flex-shrink-0">Mô tả:</p>
                            <p className="w-4/5 overflow-hidden">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras et vestibulum ante, id malesuada libero. In hac habitasse platea dictumst. Maecenas est erat, volutpat ut hendrerit efficitur, pulvinar vitae nisi. </p>
                        </div>
                        <div className="mb-3 flex">
