...
import ListStudent from '../pages/Leadership/StudentProfile/ProfileManagement/ListStudent';
...
import InfoStudents from '../pages/Leadership/StudentProfile/ProfileManagement/index';
...
const LeadershipRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      {
        path: '/leadership/student/profile/*',
      ...
      { path: '/leadership/classes/detail', element: <DetailClass /> },
