...
import ClassManagementLayout from '../components/TeacherManagement/Sidebar';
...
const TeacherRoutes: RouteObject[] = [
  {
    ...
    children: [
      {
        path: '/teacher/class-management/list',
        element: <ClassManagementLayout />,
        children: [
          { index: true, element: <div>Trang trắng quản lý lớp học</div> },
          {
            path: 'qna',
            element: <QnALayout />,
            children: [
